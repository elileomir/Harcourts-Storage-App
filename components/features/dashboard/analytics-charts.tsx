            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Call Volume & Bookings">
                        Shows daily call volume and successful bookings over the last 30 days. The blue bars represent total calls received, while the green line shows calls that resulted in bookings.
                    </ChartInfo>
                </div>
                <CardDescription>Daily call volume and successful bookings over the last 30 days</CardDescription>
            </CardHeader>
                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={data}>
                            ...
                            <Bar dataKey="calls" name="Total Calls" fill={COLORS.primary} radius={[4, 4, 0, 0]} barSize={20} />
                            <Line type="monotone" dataKey="bookings" name="Bookings" stroke={COLORS.secondary} strokeWidth={2} dot={{ r: 3, fill: COLORS.secondary }} />
                        </ComposedChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="CSAT Distribution">
                        Customer Satisfaction (CSAT) scores rated from 1-5 stars. This shows how many customers gave each rating. Higher stars (4-5) indicate positive experiences.
                    </ChartInfo>
                </div>
                        ...
                        <BarChart data={data} layout="vertical" margin={{ left: 20 }}>
                            ...
                            <Bar dataKey="count" name="Count" radius={[0, 4, 4, 0]} barSize={24}>
                                {data.map((entry, index) => (
                                    <Cell key={`cell-${index}`} fill={index >= 3 ? COLORS.secondary : index === 2 ? COLORS.accent : COLORS.danger} />
                                ))}
                            </Bar>
                        </BarChart>
                    </ResponsiveContainer>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Lead Quality">
                        AI-assessed quality of each lead based on conversation analysis. High quality leads show strong intent to rent, Medium shows interest, and Low shows minimal engagement.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[250px] w-full flex justify-center">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            ...
                            >
                                {data.map((entry, index) => (
                                    <Cell key={`cell-${index}`} fill={entry.name === 'High' ? COLORS.secondary : entry.name === 'Medium' ? COLORS.accent : COLORS.muted} />
                                ))}
                            </Pie>
                            <RechartsTooltip />
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Unit Status">
                        Current occupancy overview. Available = ready to rent, Pending Apps = application submitted, Occupied = currently rented out.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[250px] w-full flex items-center justify-center">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            ...
                            >
                                {data.map((entry, index) => (
                                    <Cell key={`cell-${index}`} fill={entry.name === 'Available' ? COLORS.secondary : entry.name === 'Pending Apps' ? COLORS.accent : COLORS.danger} />
                                ))}
                            </Pie>
                            <RechartsTooltip />
                            <Legend verticalAlign="bottom" height={36} iconType="circle" />
                            <text x="50%" y="45%" textAnchor="middle" dominantBaseline="middle">
                                <tspan x="50%" dy="0" fontSize="28" fontWeight="bold" fill="#1e293b">
                                    {total}
                                </tspan>
                                <tspan x="50%" dy="1.6em" fontSize="13" fill="#64748b">Total Units</tspan>
                            </text>
                        </PieChart>
                    </ResponsiveContainer>
                </div>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Bookings by Facility">
                        Total number of bookings for each facility location. Helps identify which facilities are most in demand.
                    </ChartInfo>
                </div>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Occupancy by Facility">
                        Shows available vs. occupied units for each facility. Calculated as (Occupied Units / Total Units) × 100%.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[250px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data}>
                            ...
                            />
                            <Legend />
                            <Bar dataKey="availableUnits" name="Available" fill={COLORS.secondary} radius={[4, 4, 0, 0]} />
                            <Bar dataKey="occupiedUnits" name="Occupied" fill={COLORS.danger} radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Average Call Duration">
                        Average duration of calls in seconds over time. Trends can indicate engagement levels and conversation quality.
                    </ChartInfo>
                </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={data}>
                            ...
                            <RechartsTooltip
                                contentStyle={{ backgroundColor: '#fff', borderRadius: '8px', border: '1px solid #e2e8f0' }}
                            />
                            <Line type="monotone" dataKey="avgDuration" name="Avg Duration (s)" stroke={COLORS.primary} strokeWidth={2} dot={{ r: 3 }} />
                        </LineChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
                ...
                <CardHeader>
                    <div className="flex items-center">
                        ...
                        <ChartInfo title="Competitor Mentions">
                            Tracks when competitors are mentioned during calls. Helps understand competitive landscape and customer shopping behavior.
                        </ChartInfo>
                    </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data} layout="vertical">
                            ...
                            <RechartsTooltip
                                contentStyle={{ backgroundColor: '#fff', borderRadius: '8px', border: '1px solid #e2e8f0' }}
                            />
                            <Bar dataKey="count" name="Mentions" fill={COLORS.accent} radius={[0, 4, 4, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="ROI Trend">
                        Return on Investment over time. Shows (Revenue - Platform Cost) / Platform Cost × 100%. Tracks how efficiently your investment in the AI platform generates revenue.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={data}>
                            ...
                            />
                            <Legend />
                            <Line type="monotone" dataKey="roi" name="ROI %" stroke={COLORS.secondary} strokeWidth={3} dot={{ r: 4 }} />
                        </ComposedChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Revenue by Facility">
                        Monthly recurring revenue from active bookings at each facility. Helps identify top revenue-generating locations.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data}>
                            ...
                            />
                            <Bar dataKey="revenue" name="Monthly Revenue" fill={COLORS.secondary} radius={[4, 4, 0, 0]}>
                                {data.map((entry, index) => (
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Conversion Funnel">
                        Shows conversion rates at each stage from initial call to active lease. Identifies where potential customers drop off in the booking process.
                    </ChartInfo>
                </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data} layout="horizontal">
                            ...
                            <Bar dataKey="count" name="Count" radius={[4, 4, 0, 0]}>
                                ...
                                <LabelList dataKey="rate" position="top" formatter={(value: any) => `${Number(value).toFixed(1)}%`} fontSize={11} />
                            </Bar>
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Lead Quality Performance">
                        Compares conversion rates by AI-assessed lead quality. Shows if high-quality leads actually convert better, validating the AI scoring.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data}>
                            ...
                            />
                            <Legend />
                            <Bar yAxisId="left" dataKey="count" name="Lead Count" fill={COLORS.primary} radius={[4, 4, 0, 0]} />
                            <Bar yAxisId="right" dataKey="rate" name="Conversion Rate" fill={COLORS.secondary} radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
            ...
            <CardHeader>
                <div className="flex items-center">
                    ...
                    <ChartInfo title="Credit Usage Breakdown">
                        Shows how ElevenLabs credits are being spent: LLM credits for AI processing vs Voice credits for call time. Helps optimize usage.
                    </ChartInfo>
                </div>
                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={data}>
                            ...
                            />
                            <Legend />
                            <Bar dataKey="llmCredits" name="LLM Credits" stackId="a" fill={COLORS.primary} radius={[0, 0, 0, 0]} />
                            <Bar dataKey="voiceCredits" name="Voice Credits" stackId="a" fill={COLORS.accent} radius={[4, 4, 0, 0]} />
                        </ComposedChart>
                    </ResponsiveContainer>
                </div>
            </CardContent>
